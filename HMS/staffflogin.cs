...
namespace HMS
{
    public partial class staffflogin : Form
    {
        ...
        private void staffflogin_Load(object sender, EventArgs e)
        {
        ...
        private void label9_Click(object sender, EventArgs e)
       {
        ...
        {
            stafffdashboaard ds = new stafffdashboaard();
            this.Hide();
            ds.ShowDialog();
            this.Close();
    ...
    public class Button_WOCthree : Button
    {
